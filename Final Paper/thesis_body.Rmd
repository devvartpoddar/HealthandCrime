...
base_model <- plm(GRNDTOT ~ lag.crime + NUI + CPOPARST + MedianIncome,
                  data = final.data)

model_control <- plm(GRNDTOT ~ lag.crime + NUI + CPOPARST + MedianIncome +
                     unemployed_pct + minority_pct,
                     data = final.data) 

model_year <-  plm(GRNDTOT ~ lag.crime + NUI + CPOPARST + MedianIncome +
                     unemployed_pct + minority_pct + as.factor(year),
                     data = final.data) 
rm(final.data)
```
